...
class TSPBoard:
    ...
    def is_terminal(self):
        ...
        For TSP, we can stop after a certain number of iterations without improvement.
        ...
        return self.no_improve_counter >= self.max_no_improve
    ...
    def get_canonical_tour(self):
        ...
        For example, rotate the tour so that it starts with the smallest node index.
